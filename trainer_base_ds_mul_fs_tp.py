...
def main(cfg: DictConfig):
    ...
    # model.to(cfg.device)
    #
    # tokenizer = AutoTokenizer.from_pretrained("pretrained-models/Llama-2-7b-chat-hf")
    # inputs = tokenizer("Hello, my name is Fangkai Jiao. What's your name?", return_tensors="pt")
    # inputs = {k: v.to(cfg.device) for k, v in inputs.items()}
    #
    # generation_config = transformers.GenerationConfig(max_new_tokens=100, num_return_sequences=1, do_sample=True, temperature=0.7)
    #
    ...
    # print(cfg.local_rank, dp_rank, mp_rank, pp_rank, loss)
    #
    # return 0
