...
input_file="${sft_dir}/meta_math_sub.100k.cot.train.0shot.n5.tem0.8.p0.9.v1.0_dsk_clean_v2.json"
...
rm_step=400
step_offset=1
reward_file="experiments/deepseek-math.7b.ins.meta_math_cot.prm.H100.w4.v1.2/meta_math_sub.100k.cot.train.0shot.n5.tem0.8.p0.9.v1.0_dsk_clean_v2.rewards.v1.0/test-checkpoint-${rm_step}/eval_predictions_rank0.json"

python scripts/cot/deepseek_dpo_pair_by_reward_v1.0.py \
  --input_file $input_file \
  --reward_file $reward_file \
  --output_file "$sft_dir/meta_math_sub.100k.cot.train.0shot.n5.tem0.8.p0.9.v1.0_dsk_clean_v2.prm_v1.2_cp${rm_step}_best_of_${best_of}.v1.0.$index.pos$pos_margin.neg$max_neg_num.${reduction}.off${step_offset}.full_only.json" \
