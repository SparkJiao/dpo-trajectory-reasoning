...
index="(2,3)"
reduction="product"
reward_file="experiments/llama2.7b.chat.logiqav2.70b-distil.prm.fix_hack.A100.w4.v1.2.s42/train.reclor.rewards.raw_trajectory.product.v1.1/test-checkpoint-800/eval_predictions_rank0.json"
data_dir="experiments/llama2.7b.chat.logiqav2.70b-distil.step.dpo.fix_hack.H100.w4.v1.0.th.s43/checkpoint-2000/"
python scripts/best_of_filter_by_reward_v2.2.py \
  --input_file "$data_dir/reclor.react.train.0shot.sample10.tem0.7.cleaned.json" \
...
#  --input_file "$data_dir/reclor.react.train.0shot.sample10.tem0.7.v1.0.cleaned.json" \
#  --reward_file $reward_file \
#  --output_file "./reward_gpt_reclor_debug_v1.3_cp400_${index}_${reduction}.json" --reduction $reduction --prob_labels ${index}
