...
reduction="product"
#reduction="min"
reward_file="experiments/llama2.7b.chat.reclor.gpt351106.prm.fix_hack.H100.w8.v1.3.s42/train.resp30merge.reclor.rewards.raw_trajectory.product.v1.0/test-checkpoint-400/eval_predictions_rank0.json"
python scripts/best_of_filter_by_reward_v2.2.py \
  --input_file "$data_dir/response30merge/reclor.react.train.0shot.resp30merge.tem0.7.v1.0.cleaned.json" \
  --reward_file $reward_file \
  --output_file "$data_dir/response30merge/reclor.react.train.0shot.resp30merge.tem0.7.v1.0.prm_v13_400_best_of_${best_of}.neg${max_neg_num}.pos${pos_margin}.v2.2.${index}.pair.${reduction}.full_only.json" \
  --best_of $best_of --max_neg_num $max_neg_num --pos_margin $pos_margin --prob_labels ${index} --reduction $reduction
...
#min_pos_step=4
#min_neg_step=-1
#reward_file="experiments/llama2.7b.chat.reclor.gpt351106.prm.fix_hack.H100.w8.v1.4.s42/train.resp30merge.reclor.rewards.raw_trajectory.product.v1.0/test-checkpoint-400/eval_predictions_rank0.json"
#python scripts/best_of_filter_by_reward_v2.2.py \
#  --input_file "$data_dir/response30merge/reclor.react.train.0shot.resp30merge.tem0.7.v1.0.cleaned.json" \
#  --reward_file $reward_file \
#  --output_file "$data_dir/response30merge/reclor.react.train.0shot.resp30merge.tem0.7.v1.0.prm_v14_400_best_of_${best_of}.neg${max_neg_num}.pos${pos_margin}.step${min_pos_step}-${min_neg_step}.v2.2.${index}.pair.${reduction}.full_only.json" \
#  --best_of $best_of --max_neg_num $max_neg_num --pos_margin $pos_margin --prob_labels ${index} --reduction $reduction \
...
#  --input_file "$data_dir/response30merge/reclor.react.train.0shot.resp30merge.tem0.7.v1.0.cleaned.json" \
#  --reward_file $reward_file \
#  --output_file "./reward_gpt_reclor_resp30merge_debug_v1.3_cp400_${index}_${reduction}.json" --reduction $reduction --prob_labels ${index}
...
#index="(1,2,3)"
#reduction="min"
##reward_file="experiments/llama2.7b.chat.reclor.gpt351106.prm.fix_hack.H100.w8.v1.3.s42/dev.reclor.rewards.raw_trajectory.product.v1.0/test-checkpoint-400/eval_predictions_rank0.json"
#reward_file="experiments/llama2.7b.chat.reclor.gpt351106.prm.fix_hack.H100.w8.v1.4.s42/dev.reclor.rewards.raw_trajectory.product.v1.0/test-checkpoint-800/eval_predictions_rank0.json"
#python scripts/combine_reward_debug_v1.0.py \
