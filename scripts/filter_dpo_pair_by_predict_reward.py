...
def main():
    ...
    parser.add_argument("--chosen_l", type=float, default=1.5)
    parser.add_argument("--chosen_r", type=float, default=100)
    parser.add_argument("--reject_l", type=float, default=-100)
    parser.add_argument("--reject_r", type=float, default=-2)
    ...
    # print(list(response2reward.keys())[:10])
    # print(json.dumps(list(duplicates)[:5], indent=2))
    ...
    for item in data:
        ...
        if args.chosen_l <= chosen_reward <= args.chosen_r and args.reject_l <= reject_reward <= args.reject_r:
