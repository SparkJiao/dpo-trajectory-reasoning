...
python scripts/process_inter_response_v2.1_by_reward.py \
  --input_file experiments/llama2.7b.chat.logiqav2.70b-distil.rm.H100.w4.v2.0/train_decay0.95.diff2.6.rewards.v1.0/test-checkpoint-200/eval_predictions_rank0.json \
  --output_file "$data_dir/value-ver2.0/logiqav2-train.qa.react.v1.0.0shot.sample10.inter_rm_ver2.1.rs0.2.r0.3.sample3.diff$diff.json" \
  --diff $diff --inter_state_file "$data_dir/logiqav2-train.full.qa.react.v1.0.0shot.sample10.clean_inter_ver2.0.rs0.2.r0.3.*-of-20.json"
